  ...
  ' Set ws as a worksheet object variable.
    ...
    For Each ws In Worksheets
        ...
        '**Fun Fact!... Definition of 'Delta' *I wanted to know when labeling*
        'Delta is the ratio that compares the change in the price of an asset, 
        ...
        If Need_Summary_Table_Header Then
         ...
         For i = 2 To Lastrow
             ...
             If ws.Cells(i + 1, 1).Value <> ws.Cells(i, 1).Value Then
                ...
                Else
                    '**FOUND ONLINE**' Unlikely, but it needs to be checked to avoid program crushing
